                ...
                for step, batch in enumerate(train_iter):
                    ...
                    if training_steps % args.gradient_accumulation_steps == 0:
                        ...
                        if (global_step - 1) % args.log_freq == 0:
                            if is_main_process():
                                print('global_step', global_step, 'lr', optimizer.optimizer.param_groups[0]['lr'], 'train_loss', average_loss / args.log_freq, 'throughput', (time.time() - batch_start) / args.log_freq)
                            average_loss = 0
                            batch_start = time.time()
